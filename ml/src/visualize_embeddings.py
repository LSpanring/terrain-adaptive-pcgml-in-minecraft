...
@cloup.option("--top-n",          type=int, help="Only show the N most frequent blocks")
@cloup.pass_context
def cli(ctx: cloup.Context, embedding_path: str, palette_path: str, only: str, top_n: int):
